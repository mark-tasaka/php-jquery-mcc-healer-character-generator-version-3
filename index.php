...
<html>
<head>
<title>Launch Page: Mutant Crawl Classics Healer Character Generator Version 3</title>
	...
	<script type="text/javascript" src="js/healerMenu.js"></script>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Mutant Crawl Classics Healer Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/mcc/classes/healer/"  class="text_link" target="_blank"><span class="bold">Artifacts of the Ancient Ones: A Mutanmy Crawl Classics Fan Site</span></a></p>
        ...
        <form action="" id ="HealerFormV3"  target="_blank" method="post">
...
<br/>
  ...
  <br/>
		...
		<div class="formIputDescription">
		   <span class="footnote3"><input type="checkbox" id="optimizeAbilityScoreV3" value="1" name="theOptimizeAbilityScore">Optimize Ability Scores: Per, Int, Luck, Str, Sta, Agi.</span>
		   </div>
  ...
  <span class="weaponSubHead">Equipment:</span><br/><br/>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#HealerFormV3").attr('action', "character3/mccHealer.php");
